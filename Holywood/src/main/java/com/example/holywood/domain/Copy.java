...
public class Copy {
	...
	public static void main(String[] args) {
		...
		} else if (args[0].equals(args[1])) { // Check if the directories are
												// different
		...
		// Check the second argument - if it is a relative path, make it
		// absolute
		...
		// If the target exists, we need more information about what to do
